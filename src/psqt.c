...
const int KnightPSQT32[32] = {
    S( -39, -47), S(  -1, -33), S(  -9, -14), S(   7,  -4),
    S(   2, -45), S(  16,  -5), S(  11, -20), S(  21,  -1),
    S(   5, -18), S(  29, -15), S(  17,   0), S(  30,  16),
    S(  14,  -4), S(  24,   8), S(  36,  21), S(  38,  24),
    S(  27,   0), S(  28,   9), S(  36,  28), S(  32,  40),
    S( -32,   9), S(  14,   4), S(  14,  26), S(  21,  27),
    S(   7, -15), S( -30,  15), S(  40, -24), S(  19,   0),
    S(-167, -33), S(-101, -25), S(-153,  -3), S( -41, -24),
};
