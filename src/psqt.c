...
const int KnightPSQT32[32] = {
    S( -39, -47), S(   1, -33), S(  -8, -13), S(   7,  -4),
    S(   1, -44), S(  16,  -5), S(  13, -20), S(  22,  -1),
    S(   7, -18), S(  28, -14), S(  17,   0), S(  29,  15),
    S(  15,  -4), S(  24,   8), S(  35,  20), S(  38,  23),
    S(  26,   0), S(  31,   9), S(  34,  27), S(  29,  39),
    S( -33,   8), S(  12,   3), S(  13,  25), S(  20,  26),
    S(   8, -15), S( -29,  15), S(  41, -23), S(  19,   0),
    S(-166, -32), S(-101, -25), S(-152,  -2), S( -41, -23),
};
