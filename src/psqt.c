...
const int KnightPSQT32[32] = {
    S( -39, -48), S(   1, -35), S(  -6, -14), S(   9,  -5),
    S(   5, -46), S(  14,  -6), S(  14, -22), S(  23,  -3),
    S(   9, -20), S(  30, -16), S(  18,   0), S(  33,  15),
    S(   9,  -2), S(  18,   5), S(  31,  23), S(  35,  28),
    S(  23,   2), S(  26,  11), S(  39,  29), S(  37,  39),
    S( -30,   8), S(  19,   4), S(  26,  27), S(  33,  26),
    S( -23, -17), S( -31,  11), S(  42, -28), S(  14,  -1),
    S(-168, -34), S(-102, -27), S(-157,  -5), S( -42, -26),
};
