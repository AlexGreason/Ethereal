...
const int KnightPSQT32[32] = {
    S( -36, -43), S(   7, -26), S(  -2, -12), S(  15,  -5),
    S(   9, -34), S(  21,  -2), S(  19, -14), S(  28,  -2),
    S(  13, -17), S(  35, -18), S(  22,   0), S(  35,  13),
    S(  22, -13), S(  32,   6), S(  41,  19), S(  43,  25),
    S(  30,   0), S(  32,   7), S(  37,  25), S(  32,  37),
    S( -49,  19), S(  10,   7), S(  -3,  33), S(  15,  31),
    S(  38, -31), S( -27,  24), S(  32, -10), S(  22,  -4),
    S(-151, -20), S( -94,  -3), S(-136,   8), S( -48, -11),
};
